...
compile_error!(
    "picocodex-oai-api supports native targets and hosted wasm*-unknown-unknown targets; WASI is not yet supported"
);
...
/// Internal bridge for the higher-level `picocodex-agent` crate.
///
...
///
/// ```
/// use picocodex_oai_api::{ImageDetail, Prompt, UserInput};
///
