use picocodex_oai_api::responses::{
    ContentItem, FunctionOutputBody, FunctionOutputContent, MessageRole, ResponseItem,
};
use picocodex_tools::contract::{ToolOutputBody, ToolOutputContent};
...
mod tests {
    use super::*;
    use picocodex_oai_api::ImageDetail;
    use picocodex_tools::contract::ToolOutputContent;
    use serde_json::json;
