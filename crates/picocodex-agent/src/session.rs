...
pub use picocodex_oai_api::session::SessionId;

use crate::{
    PicocodexError, Result,
    model::{context::ContextBaseline, run::ModelCheckpoint},
};

const SESSION_SNAPSHOT_VERSION: u32 = 1;

/// One immutable model boundary shared by forks and durable snapshots.
#[derive(Clone)]
...
/// value, but Picocodex remains responsible for interpreting model history and
...
impl SessionSnapshot {
    /// Snapshot format version understood by this Picocodex release.
    #[must_use]
