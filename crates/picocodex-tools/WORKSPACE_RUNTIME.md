...
the same handlers used by the normal Picocodex tools registry. Interactive
...
exists to build small static companions such as `picocodex-vm-guest`; it is not
