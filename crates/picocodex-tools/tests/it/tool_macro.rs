use picocodex_tools::{Tool, ToolContext, ToolInput, tool};
...
#[tokio::test]
async fn macro_works_without_the_picocodex_facade() {
    ...
    let output = deployment_region
        .execute(
            ...
            ToolContext::new(
                ...
                "test-call",
                &[],
                picocodex_tools::contract::DEFAULT_TOOL_OUTPUT_TOKENS,
            ),
        )
        .await
        .unwrap();
