(() => {
  const nativeTool = __picocodexTool;
  const nativeContent = __picocodexContent;
  const nativeNotify = __picocodexNotify;
  const nativeYield = __picocodexYield;
  const nativeSetTimeout = __picocodexSetTimeout;
  const nativeClearTimeout = __picocodexClearTimeout;
