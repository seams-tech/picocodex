...
#![cfg_attr(
    ...
    doc = "Dependency-light model-visible tool contracts for Picocodex."
)]
...
pub mod contract {
    ...
    pub use picocodex_oai_api::tools::{
...
pub mod image {
    ...
    pub use picocodex_oai_api::ImageDetail;
}
...
#[cfg(all(not(target_family = "wasm"), feature = "workspace-runtime"))]
pub(crate) use picocodex_oai_api::ImageDetail;
#[cfg(all(not(target_family = "wasm"), feature = "native"))]
#[cfg_attr(docsrs, doc(cfg(not(target_family = "wasm"))))]
pub use picocodex_tools_macros::tool;
#[cfg(feature = "native")]
...
pub mod __private {
    ...
    pub fn model_contract(
        ...
        Vec<picocodex_oai_api::tools::ToolDefinition>,
        Vec<(String, String)>,
    ) {
